			...
			<div class="flex min-h-[100dvh] flex-col px-6 py-24">
				<div class="space-y-3">
					<a
						...
						class="block translate-y-0 text-3xl font-semibold tracking-tight text-gray-900 opacity-100 transition-all duration-500"
			...
			<div class="flex items-center justify-between gap-4">
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-xs text-gray-500">Library Portal</p>
					</div>
				</div>
